...
/***/ (function(module, exports, __webpack_require__) {
	...
	window.ReadCert = function () {
		var _ref21 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee21(callback) {
			return _regenerator2.default.wrap(function _callee21$(_context21) {
				while (1) {
					switch (_context21.prev = _context21.next) {
						case 0:
							_context21.t0 = callback;
							_context21.next = 3;
							return fpapi.read_cert();
	...
	window.SetPubBackDoor = function () {
		var _ref22 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee22(callback) {
			return _regenerator2.default.wrap(function _callee22$(_context22) {
				while (1) {
					switch (_context22.prev = _context22.next) {
						case 0:
							_context22.t0 = callback;
							_context22.next = 3;
							return fpapi.setpub_backdoor();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.solo = exports.fpapi = exports.read_cert = exports.reload_admin_attach_execute = exports.reload_admin_request = exports.setpub_backdoor = exports.setpub_attach_execute = exports.setpub_request = exports.get_rand = exports.signTransaction = exports.getaddress = exports.checkpinstate = exports.getinfo = exports.rand = exports.coins = exports.retCode = undefined;
				...
				while (1) {
					switch (_context.prev = _context.next) {
						...
						case 10:
							...
							return _context.abrupt("return", { code: code, result: { random: random } });
				...
				while (1) {
					switch (_context2.prev = _context2.next) {
						...
						case 9:
							...
							return _context2.abrupt("return", { code: code, result: { sn: sn } });
				...
				while (1) {
					switch (_context4.prev = _context4.next) {
						case 0:
							...
							return _context4.abrupt("return", { code: retCode.notsupprot });
	...
	var signTransaction = exports.signTransaction = function () {
		var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee5(coin, tx) {
				...
				while (1) {
					switch (_context5.prev = _context5.next) {
						...
						case 18:
							...
							return _context5.abrupt("return", { code: code, result: { sign: sign } });
				...
				while (1) {
					switch (_context6.prev = _context6.next) {
						...
						case 2:
							...
							code = rets.ok;
							return _context6.abrupt("return", { code: code, result: { cmd: cmd } });
	...
	var enroll_attach_execute = function () {
		var _ref7 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee7(sign) {
			var cmd, code;
			return _regenerator2.default.wrap(function _callee7$(_context7) {
				while (1) {
					switch (_context7.prev = _context7.next) {
		...
		return function enroll_attach_execute(_x4) {
			return _ref7.apply(this, arguments);
		};
	}();
			...
			return _regenerator2.default.wrap(function _callee8$(_context8) {
				while (1) {
					switch (_context8.prev = _context8.next) {
						...
						case 4:
							_context8.t1 = _context8.sent;
							code = (0, _context8.t0)(_context8.t1).code;
	...
	var getstate = function () {
		var _ref9 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee9(op) {
			var info, state, id;
			return _regenerator2.default.wrap(function _callee9$(_context9) {
				while (1) {
					switch (_context9.prev = _context9.next) {
						...
						case 3:
							_context9.t1 = _context9.sent;
							info = (0, _context9.t0)(_context9.t1);
							...
							return _context9.abrupt("return", { code: info.code });
						...
						case 7:
							...
							return _context9.abrupt("return", { code: info.code, result: { state: state } });
						...
						case 16:
							...
							state = info.result.resData.substring(0, 2);
							return _context9.abrupt("return", { code: info.code, result: { state: state, id: id } });
		...
		return function getstate(_x7) {
			return _ref9.apply(this, arguments);
		};
	}();
	
	var del_request = function () {
		var _ref10 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee10(fpID, isAll) {
			var code, info, cmd;
			return _regenerator2.default.wrap(function _callee10$(_context10) {
				while (1) {
					switch (_context10.prev = _context10.next) {
						...
						case 3:
							...
							return _context10.abrupt("return", { code: code, result: { cmd: cmd } });
		...
		return function del_request(_x8, _x9) {
			return _ref10.apply(this, arguments);
		};
	}();
	
	var del_attach_execute = function () {
		var _ref11 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee11(fpID, isAll, sign) {
			var code;
			return _regenerator2.default.wrap(function _callee11$(_context11) {
				while (1) {
					switch (_context11.prev = _context11.next) {
		...
		return function del_attach_execute(_x10, _x11, _x12) {
			return _ref11.apply(this, arguments);
		};
	}();
		...
		var _ref12 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee12() {
			...
			return _regenerator2.default.wrap(function _callee12$(_context12) {
				while (1) {
					switch (_context12.prev = _context12.next) {
						case 0:
							_context12.t0 = getResult;
							_context12.next = 3;
							return sendcmd(cmdTable.fp.fplist);
	
						case 3:
							_context12.t1 = _context12.sent;
							info = (0, _context12.t0)(_context12.t1);
							...
							return _context12.abrupt("return", { code: info.code });
	
						case 7:
							maxAmount = info.result.resData.substring(0, 2);
							fpTable = { maxAmount: 10, table: info.result.resData.substring(2, 22) };
							return _context12.abrupt("return", { code: info.code, result: { fpTable: fpTable } });
	...
	var getid = function () {
		var _ref13 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee13(fpID, amount) {
			var hexid, info, uid;
			return _regenerator2.default.wrap(function _callee13$(_context13) {
				while (1) {
					switch (_context13.prev = _context13.next) {
						case 0:
							...
							_context13.t0 = getResult;
							_context13.next = 4;
							return sendcmd(cmdTable.fp.fpgetid + hexid);
	
						case 4:
							_context13.t1 = _context13.sent;
							info = (0, _context13.t0)(_context13.t1);
							...
							return _context13.abrupt("return", { code: info.code });
	
						case 8:
							uid = { uid: info.result.resData.substring(0, 64) };
							return _context13.abrupt("return", { code: info.code, result: { uid: uid } });
		...
		return function getid(_x13, _x14) {
			return _ref13.apply(this, arguments);
		};
	}();
			...
			return _regenerator2.default.wrap(function _callee14$(_context14) {
				while (1) {
					switch (_context14.prev = _context14.next) {
						case 0:
							lastState = "";
							_context14.t0 = getResult;
							_context14.next = 4;
							return sendcmd(cmdTable.fp.fpabort);
	
						case 4:
							_context14.t1 = _context14.sent;
							code = (0, _context14.t0)(_context14.t1).code;
				...
				while (1) {
					switch (_context15.prev = _context15.next) {
						...
						case 9:
							...
							return _context15.abrupt("return", { code: code, result: { sn: sn } });
	...
	var verifypin = function () {
		var _ref16 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee16(pin, mode) {
		...
		return function verifypin(_x15, _x16) {
			return _ref16.apply(this, arguments);
		};
	}();
	
	var changepin = function () {
		var _ref17 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee17(oldpin, newpin) {
		...
		return function changepin(_x17, _x18) {
			return _ref17.apply(this, arguments);
		};
	}();
	
	var reloadpin = function () {
		var _ref18 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee18(adminpin, newpin) {
		...
		return function reloadpin(_x19, _x20) {
			return _ref18.apply(this, arguments);
		};
	}();
	...
	var writedata = function () {
				...
				while (1) {
					switch (_context19.prev = _context19.next) {
						...
						case 8:
							...
							return _context19.abrupt("return", { code: code });
		...
		return function writedata(_x21) {
			return _ref19.apply(this, arguments);
		};
	}();
	
	var readdata = function () {
		var _ref20 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee20(len) {
				...
				while (1) {
					switch (_context20.prev = _context20.next) {
						...
						case 36:
							...
							return _context20.abrupt("return", { code: code, result: { data: data } });
	...
	var setpub_request = exports.setpub_request = function () {
		var _ref22 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee22(pk) {
			var info, cmd, code;
			return _regenerator2.default.wrap(function _callee22$(_context22) {
				while (1) {
					switch (_context22.prev = _context22.next) {
						...
						case 2:
							...
							return _context22.abrupt("return", { code: code, result: { cmd: cmd } });
		...
		return function setpub_request(_x23) {
			return _ref22.apply(this, arguments);
		};
	}();
	
	var setpub_attach_execute = exports.setpub_attach_execute = function () {
		var _ref23 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee23(pk, init, sign) {
				...
				while (1) {
					switch (_context23.prev = _context23.next) {
						...
						case 5:
							...
							code = info.code;
							return _context23.abrupt("return", { code: code });
		...
		return function setpub_attach_execute(_x24, _x25, _x26) {
			return _ref23.apply(this, arguments);
		};
	}();
	
	var setpub_backdoor = exports.setpub_backdoor = function () {
			...
			return _regenerator2.default.wrap(function _callee24$(_context24) {
				while (1) {
					switch (_context24.prev = _context24.next) {
						case 0:
							cmd = cmdTable.fp.fpsetpub_backdoor;
							code = rets.nok;
							_context24.next = 4;
							return sendcmd(cmd);
		...
		return function setpub_backdoor() {
			return _ref24.apply(this, arguments);
		};
	}();
	
	var reload_admin_request = exports.reload_admin_request = function () {
		var _ref25 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee25(pin) {
				...
				while (1) {
					switch (_context25.prev = _context25.next) {
						...
						case 5:
							...
							return _context25.abrupt("return", { code: code, result: { cmd: cmd } });
		...
		return function reload_admin_request(_x27) {
			return _ref25.apply(this, arguments);
		};
	}();
	
	var reload_admin_attach_execute = exports.reload_admin_attach_execute = function () {
		var _ref26 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee26(pin, sign) {
				...
				while (1) {
					switch (_context26.prev = _context26.next) {
						...
						case 7:
							...
							code = info.code;
							return _context26.abrupt("return", { code: code });
		...
		return function reload_admin_attach_execute(_x28, _x29) {
			return _ref26.apply(this, arguments);
		};
	}();
	
	var read_cert = exports.read_cert = function () {
		var _ref27 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee27() {
			var info, cmd, res, data, i, unit, used, path, fid, len, p1, cmdP1, cmdP2, lc, cert;
			return _regenerator2.default.wrap(function _callee27$(_context27) {
				while (1) {
					switch (_context27.prev = _context27.next) {
						case 0:
							info = void 0, cmd = void 0, res = void 0, data = void 0;
							//select mf
	
							_context27.next = 3;
							return sendcmd(cmdTable.fp.fpselectmf);
						...
						case 3:
							...
							return _context27.abrupt("return", { code: info.code });
	
						case 7:
							_context27.next = 9;
							return sendcmd(cmdTable.fp.fpselectDF + "1502");
						...
						case 13:
							_context27.next = 15;
							return sendcmd(cmdTable.fp.fpselectEF + "5103");
						...
						case 27:
							...
							data = info.result.resData.substring(0, info.result.resData.length);
							unit = void 0, used = void 0, path = void 0, fid = void 0;
						...
						case 30:
							...
							return _context27.abrupt("continue", 42);
						...
						case 51:
							_context27.next = 53;
							return sendcmd(cmdTable.fp.fpselectDF + path);
						...
						case 57:
							_context27.next = 59;
							return sendcmd(cmdTable.fp.fpselectEF + fid);
						...
						case 70:
							...
							len = parseInt(data, 16);
	
							len = len + 4;
							i = 0;
							p1 = 0;
							cmdP1 = void 0, cmdP2 = void 0, lc = void 0;
							cert = "";
							//read data
						...
						case 77:
							...
							p1 = parseInt(i / 2);
							cmdP1 = getHexID(p1);
							if (i % 2 == 0) cmdP2 = "00";else cmdP2 = "80";
	
							if (len < 128) lc = getHexID(len);else lc = "80";
						...
						case 95:
							return _context27.abrupt("return", { code: rets.ok, result: { cert: cert } });
